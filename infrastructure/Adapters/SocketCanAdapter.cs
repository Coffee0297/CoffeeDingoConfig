// SocketCAN (Linux only at runtime). Compiles on every platform — pure P/Invoke into libc,
// resolved at runtime — and is only registered / listed when running on Linux.
using System;
